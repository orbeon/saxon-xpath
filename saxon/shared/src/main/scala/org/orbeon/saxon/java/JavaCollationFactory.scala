...
import org.orbeon.saxon.expr.sort.{AlphanumericCollator, CodepointCollator}
...
////        stringCollator = new SimpleCollation(uri, collator.asInstanceOf[Comparator[CharSequence]])
//        stringCollator = new AlphanumericCollator(CodepointCollator.getInstance) // ORBEON
//      }
...
//      if (alphanumeric != null && !("no" == alphanumeric))
//        alphanumeric match {
//          case "yes" =>

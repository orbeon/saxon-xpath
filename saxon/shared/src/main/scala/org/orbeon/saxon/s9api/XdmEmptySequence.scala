...
object XdmEmptySequence {
  ...
  private var THE_INSTANCE: XdmEmptySequence = new XdmEmptySequence()
...
class XdmEmptySequence private () extends XdmValue(Collections.emptyList()) {

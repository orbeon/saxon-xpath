...
//
//  private val canonicalClassKeys: List[Integer] = new ArrayList(30000)
//  private val canonicalClassValues: List[Integer] = new ArrayList(30000)
//  private val decompositionKeys: List[Integer] = new ArrayList(6000)
//  private val decompositionValues: List[String] = new ArrayList(6000)
//  private val exclusionList: List[Integer] = new ArrayList(200)
//  private val compatibilityList: List[Integer] = new ArrayList(8000)
//
...
//  }
//
//  def appendJavaString(value: String, buff: FastStringBuffer): FastStringBuffer = {
//    buff.cat('"')
//    for (i <- 0 until value.length) {
//      val c = value.charAt(i)
//      if (c == '\\') buff.append("\\\\")

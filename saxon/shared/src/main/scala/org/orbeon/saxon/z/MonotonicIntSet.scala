...
import org.orbeon.saxon.z.MonotonicIntSet._
...
class MonotonicIntSet extends IntSet {
  ...
  override def union(other: IntSet): IntSet = {
    ...
    other match {
      case monotonicIntSet: MonotonicIntSet =>
        ...
        val b     : Array[Int] = monotonicIntSet.contents
        val m     : Int        = used
        val n     : Int        = monotonicIntSet.used
        var o     : Int        = 0
        var i     : Int        = 0
        var j     : Int        = 0
        while (true) {
  ...
  override def equals(other: Any): Boolean =
    other match {
      case s: MonotonicIntSet =>
        ...
        true
      case _ =>
        other.isInstanceOf[IntSet] && used == other.asInstanceOf[IntSet].size && containsAll(other.asInstanceOf[IntSet])
    }

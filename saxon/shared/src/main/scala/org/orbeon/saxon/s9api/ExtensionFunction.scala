...
/**
  ...
  * interface and register the implementation with the {@link org.orbeon.saxon.s9api.Processor}; the function will
  ...
  * functions is provided via the {@link org.orbeon.saxon.lib.ExtensionFunctionDefinition} class.</p>
  */

...
import org.orbeon.saxon.s9api.streams.Steps
...
import org.orbeon.saxon.s9api.Axis.Axis
...
class XdmNode extends XdmItem {
  ...
  override def stream(): XdmStream[XdmNode] = new XdmStream(Stream.of[XdmNode](this))

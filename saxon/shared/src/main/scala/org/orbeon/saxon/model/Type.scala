...
import org.orbeon.saxon.model.BuiltInAtomicType.{ANY_ATOMIC, ANY_URI, DAY_TIME_DURATION, DECIMAL, DURATION, INTEGER, STRING, UNTYPED_ATOMIC, YEAR_MONTH_DURATION}

...
import org.orbeon.saxon.expr.flwor.{Clause, FLWORExpression, TraceClause}
import org.orbeon.saxon.expr.instruct.{ComponentTracer, TraceExpression}
import org.orbeon.saxon.expr.parser.{CodeInjector, ExpressionTool}
...
class TraceCodeInjector extends CodeInjector {
  ...
  override def process(component: TraceableComponent): Unit = {
    val newBody = ExpressionTool.injectCode(component.getBody, this)

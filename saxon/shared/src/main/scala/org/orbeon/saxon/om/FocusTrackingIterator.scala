...
import org.orbeon.saxon.om.FocusTrackingIterator._
...
class FocusTrackingIterator(private var base: SequenceIterator)
   ...
   *         properties such as { @link org.orbeon.saxon.om.SequenceIterator.Property#GROUNDED}, { @link org.orbeon.saxon.om.SequenceIterator.Property#LAST_POSITION_FINDER},
   *         and { @link org.orbeon.saxon.om.SequenceIterator.Property#LOOKAHEAD}. It is always

...
import org.orbeon.saxon.lib.{ConversionRules, NamespaceConstant, StandardURIChecker}
import org.orbeon.saxon.ma.arrays.{ArrayItem, ArrayItemType}
import org.orbeon.saxon.ma.map.{MapItem, MapType}
import org.orbeon.saxon.model._
import org.orbeon.saxon.om.{Function, Item, NodeInfo, StructuredQName}
import org.orbeon.saxon.pattern.{AnyNodeTest, NodeKindTest, NodeTest}
import org.orbeon.saxon.s9api.ItemType._
import org.orbeon.saxon.value.{AtomicValue, NumericValue}
...
object ItemType {
  ...
  val ANY_ITEM: ItemType = new ItemType {
    ...
    def getUnderlyingItemType(): org.orbeon.saxon.model.ItemType = AnyItemType
  }
  ...
  val ANY_FUNCTION: ItemType = new ItemType {
    ...
    def getUnderlyingItemType(): org.orbeon.saxon.model.ItemType = AnyFunctionType
  }
  ...
  val ANY_NODE: ItemType = new ItemType {
    ...
    def getUnderlyingItemType(): org.orbeon.saxon.model.ItemType =
  ...
  class BuiltInAtomicItemType(
    ...
    def subsumes(other: ItemType): Boolean = {
      val otherType: org.orbeon.saxon.model.ItemType = other.getUnderlyingItemType
  ...
  val NUMERIC: ItemType = new ItemType {
    ...
    override def getUnderlyingItemType(): org.orbeon.saxon.model.ItemType =
...
abstract class ItemType {
  ...
  def getTypeName: QName = {
    val `type`: org.orbeon.saxon.model.ItemType = getUnderlyingItemType

...
//import org.orbeon.saxon.lib.{ParseOptions, Resource}
//import org.orbeon.saxon.om.{GroundedValue, SpaceStrippingRule}
...
//import org.orbeon.saxon.value.{Base64BinaryValue, DateTimeValue, Int64Value, StringValue}
//

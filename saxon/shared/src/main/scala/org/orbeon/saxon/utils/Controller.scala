...
import org.orbeon.saxon.trace.TraceEventMulticaster
import org.orbeon.saxon.trans._
import org.orbeon.saxon.tree.tiny.TinyBuilder
import org.orbeon.saxon.tree.wrapper.{SpaceStrippedDocument, SpaceStrippedNode}
import org.orbeon.saxon.value.{DateTimeValue, SequenceType}
...
class Controller extends ContextOriginator {
   ...
   *
   * @param model typically one of the constants { @link org.orbeon.saxon.om.TreeModel#TINY_TREE},
   *              { @link org.orbeon.saxon.om.TreeModel#TINY_TREE_CONDENSED}, or { @link org.orbeon.saxon.om.TreeModel#LINKED_TREE}.
   ...
   *
   * @return typically one of the constants { @link org.orbeon.saxon.om.TreeModel#TINY_TREE},
   ...
   * the attribute {@link org.orbeon.saxon.lib.FeatureKeys#TRACE_LISTENER} on the

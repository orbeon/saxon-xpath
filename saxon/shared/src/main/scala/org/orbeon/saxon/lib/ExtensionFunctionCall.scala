...
import org.orbeon.saxon.expr.{Callable, Expression, StaticContext, XPathContext}
 ...
 * {@link org.orbeon.saxon.lib.FeatureKeys# ALLOW_EXTERNAL_FUNCTIONS} is false. In cases where an <code>ExtensionFunctionCall</code>
 ...
 */
abstract class ExtensionFunctionCall
  extends Callable {
  ...
  def rewrite(
    context   : StaticContext,
    arguments : Array[Expression]
  ): Expression = null // default implementation does nothing

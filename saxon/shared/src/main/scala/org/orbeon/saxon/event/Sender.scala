...
import org.orbeon.saxon.pull.{PullProvider, PullPushCopier, PullSource}
...
import org.orbeon.saxon.utils.{Configuration, Controller, Version}
    ...
    lSource match {
      ...
      case _ => if (source.isInstanceOf[StreamSource]) {
        ...
        case _ =>
          ...
          val externalObjectModels: util.List[_] = config.getExternalObjectModels

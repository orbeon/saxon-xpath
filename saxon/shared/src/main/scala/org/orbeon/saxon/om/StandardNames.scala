...
//public static final int XS_PRECISION_DECIMAL = XS + 20;
  ...
  val XS_NMTOKENS                     : Int = XS + 45 // NB: list type
  val XS_NAME                         : Int = XS + 46
  val XS_NCNAME                       : Int = XS + 47
  val XS_ID                           : Int = XS + 48
  val XS_IDREF                        : Int = XS + 49
  val XS_IDREFS                       : Int = XS + 50 // NB: list type
  val XS_ENTITY                       : Int = XS + 51
  val XS_ENTITIES                     : Int = XS + 52 // NB: list type
  ...
  private val localNames: Array[String] = new Array[String](1023)
  private val lookup: HashMap[String, Integer] = new HashMap(1023)

  val errorVariables: Array[StructuredQName] = Array(
  ...
  def getFingerprint(uri: String, localName: String): Int = {
    val fp = lookup.get("{" + uri + "}" + localName)
    if (fp == null)
      -1
    else
      fp

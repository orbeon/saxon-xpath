...
import net.sf.saxon.regex.{BMPString, GeneralUnicodeString, UnicodeString}
import net.sf.saxon.serialize.charcode.UTF16CharacterSet
import net.sf.saxon.tree.tiny.{AppendableCharSequence, CharSlice, CompressedWhitespace}

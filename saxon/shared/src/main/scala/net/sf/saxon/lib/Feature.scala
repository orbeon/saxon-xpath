...
object Feature {
  ...
  val COLLATION_URI_RESOLVER: Feature[net.sf.saxon.lib.CollationURIResolver] =
    new Feature[net.sf.saxon.lib.CollationURIResolver](
      "http://saxon.sf.net/feature/collation-uri-resolver",
      6,
      HE,
      classOf[net.sf.saxon.lib.CollationURIResolver],
      null)
  ...
  val COLLECTION_FINDER: Feature[net.sf.saxon.lib.CollectionFinder] =
    new Feature[net.sf.saxon.lib.CollectionFinder](
      "http://saxon.sf.net/feature/collection-finder",
      8,
      HE,
      classOf[net.sf.saxon.lib.CollectionFinder],
      null)
  ...
  val ENVIRONMENT_VARIABLE_RESOLVER: Feature[
    ...
    new Feature[net.sf.saxon.lib.EnvironmentVariableResolver](
      "http://saxon.sf.net/feature/environmentVariableResolver",
      28,
      HE,
      classOf[net.sf.saxon.lib.EnvironmentVariableResolver],
      null)
  ...
  val MODULE_URI_RESOLVER: Feature[net.sf.saxon.lib.ModuleURIResolver] =
    new Feature[net.sf.saxon.lib.ModuleURIResolver](
      "http://saxon.sf.net/feature/moduleURIResolver",
      42,
      HE,
      classOf[net.sf.saxon.lib.ModuleURIResolver],
      null)
  ...
  val NAME_POOL: Feature[net.sf.saxon.om.NamePool] =
    new Feature[net.sf.saxon.om.NamePool](
      "http://saxon.sf.net/feature/namePool",
      46,
      HE,
      classOf[net.sf.saxon.om.NamePool],
      null)
  ...
  val OUTPUT_URI_RESOLVER: Feature[net.sf.saxon.lib.OutputURIResolver] =
    new Feature[net.sf.saxon.lib.OutputURIResolver](
      "http://saxon.sf.net/feature/outputURIResolver",
      49,
      HE,
      classOf[net.sf.saxon.lib.OutputURIResolver],
      null)
  ...
  val SCHEMA_URI_RESOLVER: Feature[net.sf.saxon.lib.SchemaURIResolver] =
    new Feature[net.sf.saxon.lib.SchemaURIResolver](
      "http://saxon.sf.net/feature/schemaURIResolver",
      58,
      EE,
      classOf[net.sf.saxon.lib.SchemaURIResolver],
      null)
  ...
  val TRACE_LISTENER: Feature[net.sf.saxon.lib.TraceListener] =
    new Feature[net.sf.saxon.lib.TraceListener](
      "http://saxon.sf.net/feature/traceListener",
      79,
      HE,
      classOf[net.sf.saxon.lib.TraceListener],
      null)
  ...
  val UNPARSED_TEXT_URI_RESOLVER: Feature[
    ...
    new Feature[net.sf.saxon.lib.UnparsedTextURIResolver](
      "http://saxon.sf.net/feature/unparsedTextURIResolver",
      85,
      HE,
      classOf[net.sf.saxon.lib.UnparsedTextURIResolver],
      null)

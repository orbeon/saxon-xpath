...
import net.sf.saxon.expr.{StaticProperty, XPathContext}
import net.sf.saxon.functions.{OptionsParameter, SystemFunction}
import net.sf.saxon.ma.map.MapItem
import net.sf.saxon.model.SpecificFunctionType
import net.sf.saxon.om.{Item, Sequence}
import net.sf.saxon.trans.XPathException
import net.sf.saxon.value.{BooleanValue, EmptySequence, SequenceType}

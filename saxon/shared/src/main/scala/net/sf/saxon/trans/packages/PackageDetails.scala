...
class PackageDetails {
  ...
  /**
    ...
    * The name and version number of the package
    */
  var nameAndVersion: VersionedPackageName = _
  ...
  /**
    ...
    * The executable form of the compiled package
    */
  var loadedPackage: StylesheetPackage = _
  ...
  /**
    ...
    * priority. A numerically higher value indicates a higher priority.
    */
  var priority: java.lang.Integer = _
  ...
  /**
    ...
    * code.
    */
  var staticParams: Map[StructuredQName, GroundedValue] = _

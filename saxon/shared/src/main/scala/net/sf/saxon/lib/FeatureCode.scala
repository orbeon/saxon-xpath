...
object FeatureCode {
 ...
 @see Feature#ALLOW_EXTERNAL_FUNCTIONS
    */
  val ALLOW_EXTERNAL_FUNCTIONS: Int = 1
 ...
 @see Feature#ALLOW_MULTITHREADING
    */
  val ALLOW_MULTITHREADING: Int = 2
 ...
 @see Feature#ALLOW_OLD_JAVA_URI_FORMAT
    */
  val ALLOW_OLD_JAVA_URI_FORMAT: Int = 3
 ...
 @see Feature#ALLOW_SYNTAX_EXTENSIONS
    */
  val ALLOW_SYNTAX_EXTENSIONS: Int = 4
 ...
 @see Feature#ASSERTIONS_CAN_SEE_COMMENTS
    */
  val ASSERTIONS_CAN_SEE_COMMENTS: Int = 5
 ...
 @see Feature#COLLATION_URI_RESOLVER
    */
  val COLLATION_URI_RESOLVER: Int = 6
 ...
 @see Feature#COLLATION_URI_RESOLVER_CLASS
    */
  val COLLATION_URI_RESOLVER_CLASS: Int = 7
 ...
 @see Feature#COLLECTION_FINDER_CLASS
    */
  val COLLECTION_FINDER_CLASS: Int = 9
 ...
 @see Feature#COMPILE_WITH_TRACING
    */
  val COMPILE_WITH_TRACING: Int = 12
 ...
 @see Feature#DEBUG_BYTE_CODE_DIR
    */
  val DEBUG_BYTE_CODE_DIR: Int = 16
 ...
 @see Feature#DEFAULT_REGEX_ENGINE
    */
  val DEFAULT_REGEX_ENGINE: Int = 21
 ...
 @see Feature#DISABLE_XSL_EVALUATE
    */
  val DISABLE_XSL_EVALUATE: Int = 22
 ...
 @see Feature#DTD_VALIDATION_RECOVERABLE
    */
  val DTD_VALIDATION_RECOVERABLE: Int = 25
 ...
 @see Feature#ENTITY_RESOLVER_CLASS
    */
  val ENTITY_RESOLVER_CLASS: Int = 27
 ...
 @see Feature#ENVIRONMENT_VARIABLE_RESOLVER
    */
  val ENVIRONMENT_VARIABLE_RESOLVER: Int = 28
 ...
 @see Feature#ENVIRONMENT_VARIABLE_RESOLVER_CLASS
    */
  val ENVIRONMENT_VARIABLE_RESOLVER_CLASS: Int = 29
 ...
 @see Feature#ERROR_LISTENER_CLASS
    */
  val ERROR_LISTENER_CLASS: Int = 30
 ...
 @see Feature#EXPAND_ATTRIBUTE_DEFAULTS
    */
  val EXPAND_ATTRIBUTE_DEFAULTS: Int = 31
 ...
 @see Feature#EXPATH_FILE_DELETE_TEMPORARY_FILES
    */
  val EXPATH_FILE_DELETE_TEMPORARY_FILES: Int = 32
 ...
 @see Feature#IGNORE_SAX_SOURCE_PARSER
    */
  val IGNORE_SAX_SOURCE_PARSER: Int = 34
 ...
 @see Feature#IMPLICIT_SCHEMA_IMPORTS
    */
  val IMPLICIT_SCHEMA_IMPORTS: Int = 35
 ...
 @see Feature#LAZY_CONSTRUCTION_MODE
    */
  val LAZY_CONSTRUCTION_MODE: Int = 36
 ...
 @see Feature#LICENSE_FILE_LOCATION
    */
  val LICENSE_FILE_LOCATION: Int = 37
 ...
 @see Feature#MARK_DEFAULTED_ATTRIBUTES
    */
  val MARK_DEFAULTED_ATTRIBUTES: Int = 39
 ...
 @see Feature#MAX_COMPILED_CLASSES
    */
  val MAX_COMPILED_CLASSES: Int = 40
 ...
 @see Feature#MESSAGE_EMITTER_CLASS
    */
  val MESSAGE_EMITTER_CLASS: Int = 41
 ...
 @see Feature#MODULE_URI_RESOLVER
    */
  val MODULE_URI_RESOLVER: Int = 42
 ...
 @see Feature#MODULE_URI_RESOLVER_CLASS
    */
  val MODULE_URI_RESOLVER_CLASS: Int = 43
 ...
 @see Feature#MONITOR_HOT_SPOT_BYTE_CODE
    */
  val MONITOR_HOT_SPOT_BYTE_CODE: Int = 44
 ...
 @see Feature#MULTIPLE_SCHEMA_IMPORTS
    */
  val MULTIPLE_SCHEMA_IMPORTS: Int = 45
 ...
 @see Feature#OUTPUT_URI_RESOLVER
    */
  val OUTPUT_URI_RESOLVER: Int = 49
 ...
 @see Feature#OUTPUT_URI_RESOLVER_CLASS
    */
  val OUTPUT_URI_RESOLVER_CLASS: Int = 50
 ...
 @see Feature#PRE_EVALUATE_DOC_FUNCTION
    */
  val PRE_EVALUATE_DOC_FUNCTION: Int = 51
 ...
 @see Feature#RECOGNIZE_URI_QUERY_PARAMETERS
    */
  val RECOGNIZE_URI_QUERY_PARAMETERS: Int = 53
 ...
 @see Feature#RECOVERY_POLICY_NAME
    */
  val RECOVERY_POLICY_NAME: Int = 55
 ...
 @see Feature#RESULT_DOCUMENT_THREADS
    */
  val RESULT_DOCUMENT_THREADS: Int = 56
 ...
 @see Feature#RETAIN_DTD_ATTRIBUTE_TYPES
    */
  val RETAIN_DTD_ATTRIBUTE_TYPES: Int = 57
 ...
 @see Feature#SCHEMA_URI_RESOLVER
    */
  val SCHEMA_URI_RESOLVER: Int = 58
 ...
 @see Feature#SCHEMA_URI_RESOLVER_CLASS
    */
  val SCHEMA_URI_RESOLVER_CLASS: Int = 59
 ...
 @see Feature#SCHEMA_VALIDATION_MODE
    */
  val SCHEMA_VALIDATION_MODE: Int = 61
 ...
 @see Feature#SERIALIZER_FACTORY_CLASS
    */
  val SERIALIZER_FACTORY_CLASS: Int = 62
 ...
 @see Feature#SOURCE_PARSER_CLASS
    */
  val SOURCE_PARSER_CLASS: Int = 63
 ...
 @see Feature#SOURCE_RESOLVER_CLASS
    */
  val SOURCE_RESOLVER_CLASS: Int = 64
 ...
 @see Feature#STABLE_COLLECTION_URI
    */
  val STABLE_COLLECTION_URI: Int = 65
 ...
 @see Feature#STABLE_UNPARSED_TEXT
    */
  val STABLE_UNPARSED_TEXT: Int = 66
 ...
 @see Feature#STANDARD_ERROR_OUTPUT_FILE
    */
  val STANDARD_ERROR_OUTPUT_FILE: Int = 67
 ...
 @see Feature#STRICT_STREAMABILITY
    */
  val STRICT_STREAMABILITY: Int = 69
 ...
 @see Feature#SUPPRESS_EVALUATION_EXPIRY_WARNING
    */
  val SUPPRESS_EVALUATION_EXPIRY_WARNING: Int = 73
 ...
 @see Feature#SUPPRESS_XPATH_WARNINGS
    */
  val SUPPRESS_XPATH_WARNINGS: Int = 74
 ...
 @see Feature#SUPPRESS_XSLT_NAMESPACE_CHECK
    */
  val SUPPRESS_XSLT_NAMESPACE_CHECK: Int = 75
 ...
 @see Feature#THRESHOLD_FOR_COMPILING_TYPES
    */
  val THRESHOLD_FOR_COMPILING_TYPES: Int = 76
 ...
 @see Feature#TRACE_EXTERNAL_FUNCTIONS
    */
  val TRACE_EXTERNAL_FUNCTIONS: Int = 78
 ...
 @see Feature#TRACE_LISTENER_CLASS
    */
  val TRACE_LISTENER_CLASS: Int = 80
 ...
 @see Feature#TRACE_LISTENER_OUTPUT_FILE
    */
  val TRACE_LISTENER_OUTPUT_FILE: Int = 81
 ...
 @see Feature#TRACE_OPTIMIZER_DECISIONS
    */
  val TRACE_OPTIMIZER_DECISIONS: Int = 82
 ...
 @see Feature#UNPARSED_TEXT_URI_RESOLVER
    */
  val UNPARSED_TEXT_URI_RESOLVER: Int = 85
 ...
 @see Feature#UNPARSED_TEXT_URI_RESOLVER_CLASS
    */
  val UNPARSED_TEXT_URI_RESOLVER_CLASS: Int = 86
 ...
 @see Feature#USE_PI_DISABLE_OUTPUT_ESCAPING
    */
  val USE_PI_DISABLE_OUTPUT_ESCAPING: Int = 88
 ...
 @see Feature#USE_TYPED_VALUE_CACHE
    */
  val USE_TYPED_VALUE_CACHE: Int = 89
 ...
 @see Feature#USE_XSI_SCHEMA_LOCATION
    */
  val USE_XSI_SCHEMA_LOCATION: Int = 90
 ...
 @see Feature#VALIDATION_COMMENTS
    */
  val VALIDATION_COMMENTS: Int = 91
 ...
 @see Feature#VALIDATION_WARNINGS
    */
  val VALIDATION_WARNINGS: Int = 92
 ...
 @see Feature#XML_PARSER_PROPERTY
    */
  val XML_PARSER_PROPERTY: Int = 97
 ...
 @see Feature#XQUERY_ALLOW_UPDATE
    */
  val XQUERY_ALLOW_UPDATE: Int = 98
 ...
 @see Feature#XQUERY_CONSTRUCTION_MODE
    */
  val XQUERY_CONSTRUCTION_MODE: Int = 99
 ...
 @see Feature#XQUERY_DEFAULT_ELEMENT_NAMESPACE
    */
  val XQUERY_DEFAULT_ELEMENT_NAMESPACE: Int = 100
 ...
 @see Feature#XQUERY_DEFAULT_FUNCTION_NAMESPACE
    */
  val XQUERY_DEFAULT_FUNCTION_NAMESPACE: Int = 101
 ...
 @see Feature#XQUERY_EMPTY_LEAST
    */
  val XQUERY_EMPTY_LEAST: Int = 102
 ...
 @see Feature#XQUERY_INHERIT_NAMESPACES
    */
  val XQUERY_INHERIT_NAMESPACES: Int = 103
 ...
 @see Feature#XQUERY_MULTIPLE_MODULE_IMPORTS
    */
  val XQUERY_MULTIPLE_MODULE_IMPORTS: Int = 104
 ...
 @see Feature#XQUERY_PRESERVE_BOUNDARY_SPACE
    */
  val XQUERY_PRESERVE_BOUNDARY_SPACE: Int = 105
 ...
 @see Feature#XQUERY_PRESERVE_NAMESPACES
    */
  val XQUERY_PRESERVE_NAMESPACES: Int = 106
 ...
 @see Feature#XQUERY_REQUIRED_CONTEXT_ITEM_TYPE
    */
  val XQUERY_REQUIRED_CONTEXT_ITEM_TYPE: Int = 107
 ...
 @see Feature#XQUERY_SCHEMA_AWARE
    */
  val XQUERY_SCHEMA_AWARE: Int = 108
 ...
 @see Feature#XQUERY_STATIC_ERROR_LISTENER_CLASS
    */
  val XQUERY_STATIC_ERROR_LISTENER_CLASS: Int = 109
 ...
 @see Feature#XSLT_ENABLE_ASSERTIONS
    */
  val XSLT_ENABLE_ASSERTIONS: Int = 112
 ...
 @see Feature#XSLT_INITIAL_TEMPLATE
    */
  val XSLT_INITIAL_TEMPLATE: Int = 114
 ...
 @see Feature#XSLT_STATIC_ERROR_LISTENER_CLASS
    */
  val XSLT_STATIC_ERROR_LISTENER_CLASS: Int = 116
 ...
 @see Feature#XSLT_STATIC_URI_RESOLVER_CLASS
    */
  val XSLT_STATIC_URI_RESOLVER_CLASS: Int = 117
 ...
 @see Feature#REGEX_BACKTRACKING_LIMIT
    */
  val REGEX_BACKTRACKING_LIMIT: Int = 119
 ...
 @see Feature#XPATH_VERSION_FOR_XSD
    */
  val XPATH_VERSION_FOR_XSD: Int = 120
 ...
 @see Feature#XPATH_VERSION_FOR_XSLT
    */
  val XPATH_VERSION_FOR_XSLT: Int = 121
 ...
 @see Feature#THRESHOLD_FOR_FUNCTION_INLINING
    */
  val THRESHOLD_FOR_FUNCTION_INLINING: Int = 122
 ...
 @see Feature#THRESHOLD_FOR_HOTSPOT_BYTE_CODE
    */
  val THRESHOLD_FOR_HOTSPOT_BYTE_CODE: Int = 123
 ...
 @see Feature#RETAIN_NODE_FOR_DIAGNOSTICS
    */
  val RETAIN_NODE_FOR_DIAGNOSTICS: Int = 125
 ...
 @see Feature#ALLOW_UNRESOLVED_SCHEMA_COMPONENTS
    */
  val ALLOW_UNRESOLVED_SCHEMA_COMPONENTS: Int = 126

...
import net.sf.saxon.expr.sort.{ConditionalSorter, DocumentSorter}
import net.sf.saxon.functions._
import net.sf.saxon.lib.{Logger, NamespaceConstant, StandardLogger}
...
import net.sf.saxon.trans.{Err, NoDynamicContextException, SymbolicName, XPathException}

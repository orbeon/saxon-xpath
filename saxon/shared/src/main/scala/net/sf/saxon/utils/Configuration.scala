...
import net.sf.saxon.serialize.charcode.{CharacterSetFactory, XMLCharacterData}
...
//   */
   ...
   * @throws net.sf.saxon.model.SchemaException if the schema document at the given location cannot be read or is invalid
   */
   ...
   * @throws net.sf.saxon.model.SchemaException if the schema cannot be read
   */
  @throws[SchemaException]
   ...
   * @throws net.sf.saxon.model.SchemaException if an error occurs
   */
  @throws[SchemaException]
   ...
   * @throws net.sf.saxon.model.SchemaException if the schema cannot be processed
   */
  @throws[SchemaException]
...
//  }
   ...
   *                       { @link net.sf.saxon.model.ErrorType#getInstance()}.
  ...
  def setConfigurationProperty[T](feature: Feature[T], value: T): Unit = {
    ...
    if (Configuration.booleanFeatures.contains(feature)) {
      ...
      case FeatureCode.COLLATION_URI_RESOLVER =>
        if (!value.isInstanceOf[CollationURIResolver]) throw new IllegalArgumentException("COLLATION_URI_RESOLVER value must be an instance of net.sf.saxon.lib.CollationURIResolver")
      ...
      case FeatureCode.COLLECTION_FINDER =>
        if (!value.isInstanceOf[CollectionFinder]) throw new IllegalArgumentException("COLLECTION_FINDER value must be an instance of net.sf.saxon.lib.ICollectionFinder")
      ...
      case FeatureCode.ENVIRONMENT_VARIABLE_RESOLVER =>
        if (!value.isInstanceOf[EnvironmentVariableResolver]) throw new IllegalArgumentException("ENVIRONMENT_VARIABLE_RESOLVER value must be an instance of net.sf.saxon.lib.EnvironmentVariableResolver")
      ...
      case FeatureCode.NAME_POOL =>
        if (!value.isInstanceOf[NamePool]) throw new IllegalArgumentException("NAME_POOL value must be an instance of net.sf.saxon.om.NamePool")

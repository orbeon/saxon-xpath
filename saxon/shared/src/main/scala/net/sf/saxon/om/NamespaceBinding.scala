...
/**
  ...
  * @since 9.4
  */
class NamespaceBinding(prefStr: String,
                        uriStr: String)
    extends NamespaceBindingSet {

  @BeanProperty var prefix: String = prefStr
  private var uri: String = uriStr
  ...
  /**
    ...
    * @return an Iterator.
    */
  override def iterator(): Iterator[NamespaceBinding] = new MonoIterator[NamespaceBinding](this)
